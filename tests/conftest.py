...
from app.models import Topic, QuizQuestion, ExamQuestion, PracticeTestAttempt, PracticeTestAnswer

TEST_DB_URL = "sqlite+aiosqlite:///./tests/test_quiz.db"
...
async def sample_topic(db):
    ...
    # Check if topic already exists (avoid UNIQUE constraint errors across tests)
